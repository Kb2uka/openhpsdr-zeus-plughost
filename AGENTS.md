...
place: change `repos/openhpsdr-zeus-plughost.md` or `AGENTS.md.template` in the factory and
...
## Zeus plugin host (C++, CMake) — repo section

Public repo. GPL attribution rules in `ATTRIBUTIONS.md` apply to any vendored
code.
